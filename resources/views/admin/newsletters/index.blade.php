            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        ...
                        <h1 class="title">Newsletter List</h1>
            ...
            <div class="col-lg-12">
                <section class="box">
                    ...
                    <header class="panel_header">
                        <h2 class="title pull-left">Newsletter List</h2>
                                            ...
                                            @forelse($records??array() as $item)
                                                <tr>
                                                    ...
                                                    <td id="action" class="action-td">
                                                        <a class="btn btn-primary" data-toggle="modal" data-target="#modal-edit{{$item->id}}" title="Edit Newsletter"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="title pull-left" id="">Create Newsletter</h4>
                        </div>
                        <div class="clearfix"></div>
                        <div class="modal-body">
                            <form method="POST" action="{{ url('admin/newsletters')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                                {{csrf_field()}}
                ...
                <div class="modal fade" id="modal-edit{{$item->id}}">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ url('admin/newsletters/'.$item->id) }}"  accept-charset="UTF-8" enctype="multipart/form-data" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row text-center">
                                            <input class="btn btn-primary btn-corner" type="submit" value="Update">
                                        </div>
                                    </div>
                                </form>
                            </div>

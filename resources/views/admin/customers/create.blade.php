            ...
            <div class="col-md-offset-2 col-md-8">
                <section class="box">
                    ...
                    <header class="panel_header" style="border-bottom:1px solid #eee">
                        <h2 class="title pull-left">Create Registration</h2>
                    ...
                    <div class="content-body">
                        ...
                        <form action="{{url('admin/customers')}}" method="POST" class=" padding-30"  enctype="multipart/form-data">
                            ...
                            <!--<div class="form-group">
                                ...
                                <select name="feedbackus" id="" class="form-control">

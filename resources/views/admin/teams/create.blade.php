                ...
                <div class="page-title">
                    ...
                    <div class="pull-right hidden-xs">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="/admin/users"><i class="fa fa-home"></i>Team Member List</a>
                            </li>
                            <li class="active">
                                <strong>Create
                                </strong>
            ...
            <div class="col-md-offset-2 col-md-8">
                <section class="box">
                    ...
                    <header class="panel_header" style="border-bottom:1px solid #eee">
                        <h2 class="title pull-left">Create Team Member</h2>
                    ...
                    <div class="content-body">
                        ...
                        <form action="{{url('admin/users')}}" method="POST" class=" padding-30"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls input-group phone">
                                    <span class="input-group-addon" id="dial_code"></span>

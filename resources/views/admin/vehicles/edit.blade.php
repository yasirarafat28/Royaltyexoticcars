                            ...
                            <fieldset>
                                <div class="body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" class="editor" required>{{$vehicle->description}}</textarea>
                                    </div>
                                    <div class="row">
...
:'                                                    <option {{$vehicle->category_id==$ca->id?'selected':''}} value="{{$ca->id}}" >{{$ca->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="sub_category_id" required id="subcategory" class="form-control">
                                                ...
                                                @if(isset($subcategory))
                                                    @foreach($subcategory??array() as $sub)
                                                        <option {{$vehicle->sub_category_id==$sub->id?'selected':''}} value="{{$sub->id}}" >{{$sub->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                            ...
                                            <select name="brand_id" required id="brand" class="form-control">
                                                ...
                                                @if(isset($brand))
                                                    @foreach($brand??array() as $br)
                                                        <option {{$vehicle->brand_id==$br->id?'selected':''}} value="{{$br->id}}" >{{$br->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6" >
                                            ...
                                            <select class="form-control" name="tax_id" id="texable" >
                                                ...
                                                <option  {{$t->id==$vehicle->tax_id?'selected':''}} value="{{$t->id}}" >{{$t->tax_name}}  ({{$t->rate}}%)</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4" >
                                            ...
                                            <select name="four_hour" id="" class="form-control">
                                                <option {{$vehicle->four_hour=='yes'?'selected':''}} value="yes" >Yes</option>
                                                <option {{$vehicle->four_hour=='no'?'selected':''}} value="no" >No</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">{{__('messages.selling_price')}}<span class="reqfield">*</span>
                                            </label>
                                            <input name="four_hour_price" value="{{$vehicle->four_hour_price}}" type="number" step="any" class="form-control" aria-invalid="false" placeholder="{{__('messages.selling_price')}}">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">{{__('messages.spe_price')}}</label>
                                            <input name="four_hour_discount" value="{{$vehicle->four_hour_discount}}" type="number" class="form-control" aria-invalid="false" placeholder="{{__('messages.spe_price')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4" >
                                            ...
                                            <select name="eight_hour" id="" class="form-control">
                                                <option {{$vehicle->eight_hour=='yes'?'selected':''}} value="yes" >Yes</option>
                                                <option {{$vehicle->eight_hour=='no'?'selected':''}} value="no" >No</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">{{__('messages.selling_price')}}<span class="reqfield">*</span>
                                            </label>
                                            <input name="eight_hour_price" value="{{$vehicle->eight_hour_price}}" type="number" step="any" class="form-control" aria-required="true" aria-invalid="false" placeholder="{{__('messages.selling_price')}}">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">{{__('messages.spe_price')}}</label>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4" >
                                            ...
                                            <select name="full_day" id="" class="form-control">
                                                <option {{$vehicle->full_day=='yes'?'selected':''}} value="yes" >Yes</option>
                                                <option {{$vehicle->full_day=='no'?'selected':''}} value="no" >No</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">{{__('messages.selling_price')}}<span class="reqfield">*</span>
                                            </label>
                                            <input name="full_day_price" type="number" value="{{$vehicle->full_day_price}}" step="any" class="form-control" aria-required="true" aria-invalid="false" placeholder="{{__('messages.selling_price')}}">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">{{__('messages.spe_price')}}</label>
                                            <input name="full_day_discount" value="{{$vehicle->full_day_discount}}" type="number" class="form-control" aria-invalid="false" placeholder="{{__('messages.spe_price')}}">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input name="stock" type="number" value="{{$vehicle->stock}}" class="form-control" aria-invalid="false" placeholder="Stock Quantity">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">Availability {{__('messages.start')}}</label>
                                            <input name="available_from" value="{{date('Y-m-d',strtotime($vehicle->available_from))}}" type="date" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="name" class="control-label mb-1">Availability {{__('messages.to')}}</label>
                                            <input name="available_to" type="date" value="{{date('Y-m-d',strtotime($vehicle->available_to))}}" class="form-control" aria-required="true" aria-invalid="false">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                                            ...
                                            @if(isset($vehicle->additional_image))
                                                ...
                                                @foreach($imagels as $imls)
                                                    <div id="imgid{{$i}}" class="add-img">
                                                        ...
                                                        <img src="{{asset($imls)}}" class="img-thumbnail imgsize" id="additional_img{{$i}}" name="arrimg[]" />
                                                        <div class="add-box">
                                                            <input type="hidden" id="additionalimg{{$i}}" name="additional_img[]" value="{{asset($imls)}}"/>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table class="table table-striped table-bordered cmr1">
                                                    ...
                                                    <!--<tr id="attrrow01">
                                                        <td>Class</td>
                                                        <td><input  class="form-control" type="text" name="vehicle_class" value="{{$vehicle->vehicle_class}}"></td>
                                                    </tr>
                                                    <tr id="attrrow01">
                                                        <td>Body</td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table class="table table-striped table-bordered cmr1">
                                                    ...
                                                    <tr id="attrrow01">
                                                        <td>Horse Power</td>
                                                        <td><input  class="form-control" type="text" name="horse_power" value="{{$vehicle->horse_power}}"></td>
                                                    </tr>
                                                    <tr id="attrrow01">
                                                        <td>Torque</td>
                                                        <td><input  class="form-control" type="text" name="torque" value="{{$vehicle->torque}}"></td>
                                                    </tr>
                                                    <tr id="attrrow01">
                                                        <td>Transmission</td>
                                                        <td><input  class="form-control" type="text" name="transmission" value="{{$vehicle->transmission}}"></td>
                                                    </tr>
                                                    <tr id="attrrow01">
                                                        <td>Suspension</td>
                                                        <td><input  class="form-control" type="text" name="suspension" value="{{$vehicle->suspension}}"></td>
                                                    </tr>
                                                    <!--<tr id="attrrow01">
                                                        <td>Clearance</td>
                                                        <td><input  class="form-control" type="text" name="clearance" value="{{$vehicle->clearance}}"></td>
                                                    </tr>
                                                    <tr id="attrrow01">
                                                        <td>Differential</td>
                                                        <td><input  class="form-control" type="text" name="differential" value="{{$vehicle->differential}}"></td>
                                                    </tr>
                                                    <tr id="attrrow01">
                                                        <td>Gear Ratio</td>
                                                        <td><input  class="form-control" type="text" name="gear_ratio" value="{{$vehicle->gear_ratio}}"></td>
                                                    </tr>-->
                                                    </tbody>
                                                </table>
                                            </td>

           ...
           <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="padding-30">
                      <form method="POST" action="{{ url('admin/gift-card/packages')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                          {{csrf_field()}}
                          ...
                          <div class="form-group  col-md-6">
                              ...
                              <input class="form-control" name="price" type="number" id="price" step="amount">

                          </div>

                          <div class="form-group  col-md-6">
                              <label for="name" class="control-label">Equivalent Amount</label>
                              <input class="form-control" name="equivalent_amount" type="number" id="equivalent_amount">
                          </div>

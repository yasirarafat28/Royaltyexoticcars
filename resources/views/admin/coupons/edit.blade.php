                ...
                <div class="page-title">
                    ...
                    <div class="pull-right hidden-xs">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="/admin/coupons"><i class="fa fa-home"></i>Coupon/Voucher List</a>
                            </li>
                            <li class="active">
                                <strong>Edit
                                </strong>
            ...
            <div class="col-md-offset-2 col-lg-8">
                <section class="box">
                    ...
                    <header class="panel_header">
                        <h2 class="title pull-left">Edit Coupon/Voucher</h2>
                    ...
                    <div class="content-body">
                        ...
                        <div class="padding-30">
                            <form method="POST" action="{{ url('admin/coupons/'.$item->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
                                {{csrf_field()}}
                                {{method_field('PATCH')}}
                                ...
                                <div class="form-group  col-md-6">
                                    ...
                                    <select name="item_id" class="form-control" id="type">
                                        ...
                                        @foreach($products??array() as $product)
                                            <option {{$item->item_id==$product->id?'selected':''}} value="{{$product->id}}">{{$product->name}}</option>
                                        @endforeach
                                    </select>
                                </div>

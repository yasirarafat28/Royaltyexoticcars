<!DOCTYPE html>
<!--  Last Published: Wed Feb 26 2020 12:23:13 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="5e4bf2866640d0302f8515b4" data-wf-site="5e4bf2866640d011018515a5">
<head>
  <meta charset="utf-8">
  ...
  <link href="css/gregfins-copy1.css" rel="stylesheet" type="text/css">
  <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js" type="text/javascript"></script>
  <script type="text/javascript">WebFont.load({  google: {    families: ["Poppins:100,200,300,regular,500,600,700,800,900:devanagari,latin,latin-ext"]  }});</script>
...
<body>
  <div class="utility-page-wrap">
    <div class="utility-page-content w-password-page w-form">
      <form action="/.wf_auth" method="post" class="utility-page-form w-password-page"><img src="https://d3e54v103j8qbb.cloudfront.net/static/password-page-lock.832ca8e2c9.svg" alt="">
        <h2 class="heading-56">Protected Page</h2><input type="password" autofocus="true" maxlength="256" name="pass" placeholder="Enter your password" class="text-field-20 w-password-page w-input"><input type="submit" value="Submit" data-wait="Please wait..." class="submit-button-3 w-password-page w-button">
  ...
  <script src="js/gregfins-copy1.js" type="text/javascript"></script>

...
<body>
      ...
      <ul>
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
            ...
            <li class="cd-schedule__event">
              <a data-start="11:30" data-end="13:00" data-content="event-restorative-yoga" data-event="event-4"
                href="#0">
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
            <li class="cd-schedule__event">
              <a data-start="09:00" data-end="10:15" data-content="event-restorative-yoga" data-event="event-4"
                href="#0">
                <em class="cd-schedule__name">Restorative Yoga</em>
              </a>
            </li>
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
            ...
            <li class="cd-schedule__event">
              <a data-start="12:00" data-end="13:45" data-content="event-restorative-yoga" data-event="event-4"
                href="#0">
                <em class="cd-schedule__name">Restorative Yoga</em>
              </a>
            </li>
  ...
  <div class="cd-schedule cd-schedule--loading margin-top-lg margin-bottom-lg js-cd-schedule">
    ...
    <div class="cd-schedule__events">
      <ul>
        <li class="cd-schedule__group">
          <div class="cd-schedule__top-info"><span>06-Aug</span></div>
        ...
        <li class="cd-schedule__group">
          <div class="cd-schedule__top-info"><span>07-Aug</span></div>
        ...
        <li class="cd-schedule__group">
          <div class="cd-schedule__top-info"><span>08-Aug</span></div>
        ...
        <li class="cd-schedule__group">
          <div class="cd-schedule__top-info"><span>09-Aug</span></div>
        ...
        <li class="cd-schedule__group">
          <div class="cd-schedule__top-info"><span>10-Aug</span></div>
